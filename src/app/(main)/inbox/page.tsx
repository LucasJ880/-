          ...
          <div className="flex flex-col items-center justify-center gap-4 pt-12 text-center">
            ...
            <div>
              ...
              <div className="mt-2 flex flex-col gap-1 text-xs text-muted">
                <span>创建<b className="text-blue-600">任务</b>？试试 &ldquo;周五前完成季度报表&rdquo;</span>
                <span>安排<b className="text-emerald-600">日程</b>？试试 &ldquo;明天下午两点开产品评审会&rdquo;</span>
              </div>
            </div>
            <Link
              href="/assistant"
    ...
    <div className="rounded-xl border border-border bg-card-bg">
      <div className="flex items-start justify-between gap-3 border-b border-border px-4 py-3">
        ...
        <button
          ...
          className="shrink-0 rounded p-1 text-muted transition-colors hover:bg-red-50 hover:text-red-500"
          title="移除"
        >
          <Trash2 size={14} />
        </button>
      ...
      <div className="px-4 py-3">
        ...
        {item.status === "error" && (
          <p className="text-sm text-red-500">{item.aiText}</p>
        )}
          ...
          <>
            {item.suggestion ? (
              ...
              <div className="space-y-1 text-xs text-muted">
                <p>未识别出明确的工作事项。</p>
                <p>创建<b className="text-blue-600">任务</b>？试试 &ldquo;周五前完成XX&rdquo;</p>
                <p>安排<b className="text-emerald-600">日程</b>？试试 &ldquo;明天下午两点开会&rdquo;</p>
              </div>
            )}
