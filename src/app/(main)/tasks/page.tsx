              ...
              >
                <div className="min-w-0 flex-1">
                  <div className="flex items-center gap-2">
                    ...
                    {task.needReminder && (
                      <Bell size={12} className="shrink-0 text-[#9a6a2f]" />
                    )}
                    {dueStatus && (
                      <span
                        className={cn(
                ...
                <button
                  ...
                  className="rounded p-1.5 text-muted opacity-0 transition-all group-hover:opacity-100 hover:bg-[rgba(43,96,85,0.04)] hover:text-accent"
                >
                  <Pencil size={15} />
                </button>
                <button
                  onClick={() => handleDelete(task.id)}
                  className="rounded p-1.5 text-muted opacity-0 transition-all group-hover:opacity-100 hover:bg-[rgba(166,61,61,0.04)] hover:text-[#a63d3d]"
                >
                  <Trash2 size={15} />
                </button>
              </div>
