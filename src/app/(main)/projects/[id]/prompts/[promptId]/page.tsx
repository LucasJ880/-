        ...
        <div className="flex shrink-0 items-center gap-2">
          ...
          {canManage && isTest && hasProd && prompt.activeVersion && (
            <button
              ...
              className="flex items-center gap-1 rounded-[var(--radius-sm)] bg-accent px-3 py-1.5 text-sm text-[color:var(--on-accent)] hover:bg-accent-hover"
            >
            ...
            <form onSubmit={handleSave} className="space-y-4">
              ...
              <div className="flex items-center gap-3">
                <button
                  type="submit"
                  disabled={saving}
                  className="flex items-center gap-1.5 rounded-lg bg-accent px-4 py-2 text-sm text-[color:var(--on-accent)] hover:bg-accent-hover disabled:opacity-50"
                >
                  {saving ? (
                    <>
