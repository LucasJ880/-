...
export function TaskCard({
  ...
  return (
    <div className="my-2 rounded-xl border border-accent/15 bg-gradient-to-br from-accent-soft/40 to-accent-soft/30">
      <div className="flex items-center justify-between border-b border-accent/10 px-4 py-2.5">
        ...
        <button
          ...
          className="flex items-center gap-1 rounded px-2 py-0.5 text-[11px] text-accent transition-colors hover:bg-accent-soft"
        >
          <Pencil size={11} />
          {editing ? "完成" : "修改"}
        </button>
        ...
        {editing ? (
          ...
          <>
            ...
            <div className="flex flex-wrap gap-2">
              ...
              {form.needReminder && (
                <span className="flex items-center gap-1 rounded-full border border-warning/15 bg-warning-bg px-2 py-0.5 text-[11px] font-medium text-warning">
                  <Bell size={11} />
                  需要提醒
                </span>
              )}
      ...
      <div className="flex items-center gap-2 border-t border-accent/10 px-4 py-2.5">
        <button
          ...
          className="flex items-center gap-1.5 rounded-lg bg-accent px-3.5 py-1.5 text-xs font-medium text-[color:var(--on-accent)] transition-colors hover:bg-accent-hover disabled:opacity-50"
        >
