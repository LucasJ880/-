...
export function BlindsOrderForm({
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Header info bar */}
      <div className="flex items-center gap-3 rounded-lg bg-gray-50 px-4 py-2 text-xs text-gray-500">
        <span>规则版本:</span>
      ...
      <div className="rounded-xl border border-gray-200 bg-white p-5 shadow-sm">
        <h2 className="mb-4 text-base font-semibold text-gray-800">订单信息</h2>
        <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
          ...
          <div>
            <label className="mb-1 block text-xs font-medium text-gray-600">电话</label>
            <input
              type="text"
              value={form.phone}
          ...
          <div className="sm:col-span-2">
            <label className="mb-1 block text-xs font-medium text-gray-600">安装地址</label>
            <input
              type="text"
              value={form.address}
          ...
          <div>
            <label className="mb-1 block text-xs font-medium text-gray-600">安装时间</label>
            <input
              type="text"
        ...
        <div className="overflow-x-auto">
          <table className="w-full text-xs">
            ...
            <tbody className="divide-y divide-gray-50">
              {items.map((item, i) => (
                <tr key={item.key} className={`group ${isRowInvalid(item) ? "bg-red-50/60" : "hover:bg-blue-50/30"}`}>
                  ...
                  <td className="px-1 py-1">
                    <select
                      ...
                      className="w-full rounded border border-gray-200 px-1 py-1.5 text-xs outline-none focus:border-blue-400"
                    >
            ...
            <table className="w-full text-xs">
              ...
              <tbody className="divide-y divide-gray-50">
                {items.map((item, i) => {
                  ...
                  return (
                    <tr key={item.key} className="hover:bg-blue-50/30">
                      <td className="px-3 py-2 text-gray-400">{i + 1}</td>
