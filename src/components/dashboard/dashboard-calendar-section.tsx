            ...
            >
              ...
              <div className="min-w-0 flex-1">
                ...
                <div className="mt-0.5 flex items-center gap-3 text-[11px] text-muted">
                  ...
                  {ev.source === "google" && (
                    <span className="flex items-center gap-1 rounded bg-[rgba(166,61,61,0.04)] px-1 py-0.5 text-[10px] font-medium text-[#a63d3d]">
                      Google
                    </span>
                  )}
                  {ev.task && (
              ...
              {ev.source !== "google" && (
                <>
                  <button
                    type="button"
                    onClick={() => onEdit(ev)}
                    className="shrink-0 rounded p-1 text-muted opacity-0 transition-all group-hover:opacity-100 hover:bg-[rgba(43,96,85,0.04)] hover:text-accent"
                  >
                    <Pencil size={13} />
                  </button>
                  <button
                    ...
                    className="shrink-0 rounded p-1 text-muted opacity-0 transition-all group-hover:opacity-100 hover:bg-[rgba(166,61,61,0.04)] hover:text-[#a63d3d]"
                  >
                    <Trash2 size={13} />
                  </button>
                </>
