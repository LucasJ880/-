  ...
  return (
    <div className="flex items-start justify-between gap-3 rounded-lg border border-border/80 bg-background/30 px-3 py-2.5">
      ...
      >
        <span
          className={cn(
            "absolute top-0.5 h-5 w-5 rounded-full bg-card-bg shadow transition-transform",
  ...
  return (
    <div className="rounded-xl border border-border bg-card-bg p-5">
      ...
      <button
        ...
        onClick={save}
        disabled={saving}
        className="mt-4 inline-flex items-center gap-2 rounded-lg bg-accent px-4 py-2 text-sm font-medium text-[color:var(--on-accent)] hover:bg-accent-hover disabled:opacity-50"
      >
