...
export const NAVIGATION_REGISTRY: NavigationItem[] = [
  ...
  },
  {
    key: "autopilot",
    label: "Autopilot",
    labelKey: "nav_autopilot",
    href: "/ai/autopilot",
    icon: Gauge,
    group: "CAPABILITIES",
    collapsible: true,
    autopilotOwnerOnly: true,
    matchPaths: ["/ai/autopilot"],
    displayOrder: 20,
    children: [
      {
        key: "autopilot-overview",
        label: "总览",
        labelKey: "nav_autopilot_overview",
        href: "/ai/autopilot",
        group: "CAPABILITIES",
        exact: true,
        autopilotOwnerOnly: true,
      ...
      },
      {
        key: "autopilot-runs",
        label: "Runs",
        labelKey: "nav_autopilot_runs",
        href: "/ai/autopilot/runs",
        group: "CAPABILITIES",
        autopilotOwnerOnly: true,
        displayOrder: 20,
      },
  ...
  {
    key: "biz-trade-quotes",
    label: "外贸报价",
    labelKey: "nav_trade_quotes",
    href: "/trade/quotes",
    icon: FileText,
    group: "BUSINESS",
    moduleKey: "trade",
