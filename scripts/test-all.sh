...
run_test "Workforce 2C-1 Expiry 竞态确定性" "npx tsx src/lib/workforce-runtime/__tests__/phase2c1-expiry-races.test.ts"
# Lane D Read Model（纯投影，零 DB）
...
run_test "Tender/Project 安全P0 AgentTask execute/cancel 路由级授权" "npx tsx src/app/api/agent/tasks/__tests__/route-exec.test.ts"
...
run_test "Phase3A-5 Overview Acceptance" "npx tsx src/lib/capabilities/__tests__/phase3a5-overview-acceptance.test.ts"
run_test "Security-1 Org Access Mode" "npx tsx src/lib/organizations/__tests__/org-access.test.ts"
run_test "Security-1 Org Switch Audit" "npx tsx src/lib/organizations/__tests__/org-switch-audit.test.ts"
...
run_test "销售可视化产品素材就绪" "npx tsx src/lib/visualizer/__tests__/catalog-readiness.test.ts"
...
run_test "销售可视化HD主输入选择" "npx tsx src/lib/visualizer/__tests__/hd-source-image.test.ts"
run_test "销售可视化HD mask padding" "npx tsx src/lib/visualizer/__tests__/mask-padding.test.ts"
run_test "销售可视化HD窗户mask" "npx tsx src/lib/visualizer/__tests__/hd-window-mask.test.ts"
run_test "销售可视化HD render核心" "npx tsx src/lib/visualizer/__tests__/hd-render-core.test.ts"
...
run_test "招标自动分析入队结果规范化" "npx tsx src/lib/tender-auto-analysis/__tests__/enqueue-outcome.test.ts"
run_test "招标自动分析包就绪门" "npx tsx src/lib/tender-auto-analysis/__tests__/package-ready.test.ts"
run_test "招标自动分析编排开关" "npx tsx src/lib/tender-auto-analysis/__tests__/auto-flags.test.ts"
...
run_test "招标 Analyst 综合解读语义矩阵（SEM-01..10）" "npx tsx src/lib/tender-analyst/__tests__/analyst-synthesis.test.ts"
