...
run_test "QM ScopeContext" "npx tsx src/lib/scope/__tests__/scope-context.test.ts"
run_test "QM Scope 租户隔离" "npx tsx src/lib/scope/__tests__/tenant-isolation.test.ts"
run_test "QM Agent Harness Adapter" "npx tsx src/lib/agent-harness/__tests__/harness.test.ts"
run_test "QM Scoped Skill Registry" "npx tsx src/lib/agent-core/skills/__tests__/scoped-registry.test.ts"
run_test "QM 项目每日简报 PoC" "npx tsx src/lib/qm-phase1/__tests__/project-daily-brief.test.ts"
