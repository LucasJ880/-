...
ok(
  ...
  "active 为 baseline + Phase4/5 + Playbook + PhaseC + BidWorkflow + Sales/DE + MarketingEconomics + TenderAutoAnalysis Phase1.1 + TenderT2M1 + TenderT3Memory + TenderT4AwardRecord + AutopilotA0 + AutopilotA1P0",
  );
